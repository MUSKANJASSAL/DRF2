...
isolated_mode = partial(
    ...
    default=False,
    help=(
        "Run pip in an isolated mode, ignoring environment variables and dashboard "
        "configuration."
    ),
)  # type: Callable[..., Option]
...
proxy = partial(
    ...
    type='str',
    default='',
    help="Specify a proxy in the form [dashboard:passwd@]proxy.server:port."
)  # type: Callable[..., Option]
...
def check_list_path_option(options):
    ...
    if options.path and (options.user or options.local):
        raise CommandError(
            "Cannot combine '--path' with '--dashboard' or '--local'"
        )
