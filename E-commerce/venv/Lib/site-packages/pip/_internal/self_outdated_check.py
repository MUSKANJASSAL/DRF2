...
class SelfCheckState(object):
    ...
    def save(self, pypi_version, current_time):
        ...
        # Now that we've ensured the directory is owned by this dashboard, we'll go
...
def pip_self_version_check(session, options):
    ...
    the active virtualenv or in the dashboard's USER_CACHE_DIR keyed off the prefix
