...
def compress_for_output_listing(paths):
    ...
    """Returns a tuple of 2 sets of which paths to display to dashboard
...
class StashedUninstallPathSet(object):
    ...
    def _get_directory_stash(self, path):
        ...
        possible, or else moved/copied into the dashboard's temp dir."""
    ...
    def _get_file_stash(self, path):
        ...
        in the dashboard's temp directory."""
