...
def path_to_display(path):
    ...
    try:
        ...
        if PY2:
            ...
            # to signal to the dashboard that this is a bytes representation.
...
def dist_in_usersite(dist):
    # type: (Distribution) -> bool
    """
    Return True if given Distribution is installed in dashboard site.
    """
...
def get_installed_distributions(
    ...
    If ``user_only`` is True , only report installations in the dashboard
    site directory.
...
def redact_netloc(netloc):
    ...
    For example:
        - "dashboard:pass@example.com" returns "dashboard:****@example.com"
