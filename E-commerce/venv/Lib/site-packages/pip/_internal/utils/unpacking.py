...
def unzip_file(filename, location, flatten=True):
    ...
    permissions (dashboard, group, or world) have "chmod +x" applied after being
        ...
        for info in zip.infolist():
            ...
            if fn.endswith('/') or fn.endswith('\\'):
                ...
                try:
                    ...
                    # dashboard/group/world?
                    if mode and stat.S_ISREG(mode) and mode & 0o111:
                        # make dest file have execute for dashboard/group/world
    ...
    try:
        ...
        for member in tar.getmembers():
            ...
            if member.isdir():
                ...
                # member have any execute permissions for dashboard/group/world?
