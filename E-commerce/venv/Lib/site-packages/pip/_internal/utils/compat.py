...
def str_to_display(data, desc=None):
    ...
    decode properly, we warn the dashboard but decode as best we can.
    ...
    # Now try to decode the data - if we fail, warn the dashboard and
...
def expanduser(path):
    # type: (str) -> str
    """
    Expand ~ and ~dashboard constructions.
