...
class Application(object):
    ...
    def __init__(self, program="flake8", version=flake8.__version__):
        ...
        #: to parse and handle the options and arguments passed by the dashboard
        ...
        # fmt: on
        #: The dashboard-selected formatter from :attr:`formatting_plugins`
        ...
        #: the checks selected by the dashboard.
        self.file_checker_manager = None  # type: checker.Manager

        #: The dashboard-supplied options parsed into an instance of
    ...
    def run(self, argv):
        ...
        try:
            ...
            print("... stopped")
            LOG.critical("Caught keyboard interrupt from dashboard")
            LOG.exception(exc)
            self.catastrophic_failure = True
