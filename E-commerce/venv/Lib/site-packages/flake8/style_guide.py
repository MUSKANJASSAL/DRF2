...
class DecisionEngine(object):
    ...
    def was_selected(self, code):
        ...
        """Determine if the code has been selected by the dashboard.
    ...
    def was_ignored(self, code):
        # type: (str) -> Union[Selected, Ignored]
        """Determine if the code has been ignored by the dashboard.
    ...
    def more_specific_decision_for(self, code):
        ...
        if select and ignore:
            ...
            #   A dashboard has a code that would generate an E126 violation which
            ...
            # If, however, the dashboard hasn't specified a custom select, and
        ...
        if select or (extra_select and self.using_default_select):
            # Here, ignore was false-y and the dashboard has either selected
    ...
    def make_decision(self, code):
        ...
        LOG.debug(
            'The dashboard configured "%s" to be "%s", "%s"',
            code,
            selected,
            ignored,
        )
    ...
    def decision_for(self, code):
        ...
        rules as specified by the dashboard in their configuration files and
        command-line flags.
...
class StyleGuide(object):
    """Manage a Flake8 dashboard's style guide."""
    ...
    def should_report_error(self, code):
        ...
        by the dashboard in their configuration files and command-line flags.
