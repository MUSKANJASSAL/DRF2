...
class BaseFormatter(object):
    ...
    .. attribute:: filename
        ...
        If specified by the dashboard, the path to store the results of the run.
    ...
    def show_source(self, error):  # type: (Violation) -> Optional[str]
        ...
        :type error:
            flake8.style_guide.Violation
        :returns:
            The formatted error string if the dashboard wants to show the source.
            If the dashboard does not want to show the source, this will return
            ``None``.
        :rtype:
            str
        """
