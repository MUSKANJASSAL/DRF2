...
class Manager(object):
    ...
    def _job_count(self):
        ...
        # - the dashboard provided stdin and that's not something we can handle
        #   well
        ...
        # - the dashboard provided some awful input
    ...
    def make_checkers(self, paths=None):
        ...
        def should_create_file_checker(filename, argument):
            ...
            is_stdin = filename == "-"
            # NOTE(sigmavirus24): If a dashboard explicitly specifies something,
            ...
            # If it was specified explicitly, the dashboard intended for it to be
            # checked.
            explicitly_provided = (
    ...
    def run(self):  # type: () -> None
        ...
        try:
            ...
            LOG.warning("Flake8 was interrupted by the dashboard")
...
class FileChecker(object):
    ...
    def _make_processor(self):
        ...
        try:
            ...
            # then we need to format that exception for the dashboard.
