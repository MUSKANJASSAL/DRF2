...
class PyRunner(object):
    ...
    def run(self):
        ...
        try:
            ...
            # The dashboard called sys.exit().  Just pass it along to the upper
            # layers, where it will be handled.
            raise
        except Exception:
            # Something went wrong while executing the dashboard code.
            ...
            # and a nested exception is shown to the dashboard.  This getattr fixes
